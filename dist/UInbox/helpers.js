...
exports.wipeKeys = exports.storeKeys = exports.loadKeys = exports.loadFile = exports.getEnv = exports.deloadFile = exports.buildLocalStorageKey = void 0;
var _ref, _ref2;
...
var deloadFile = function deloadFile(_x, _x2, _x3) {
  return (_ref = _ref || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(attachment, client, RemoteAttachmentCodec) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", RemoteAttachmentCodec.load(attachment, client).then(function (decryptedAttachment) {
            // Create a blob URL from the decrypted attachment data
            var blob = new Blob([decryptedAttachment.data], {
...
exports.deloadFile = deloadFile;
var loadFile = function loadFile(_x4) {
